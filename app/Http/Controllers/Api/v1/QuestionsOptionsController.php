...
use App\Http\Resources\QuestionsOptionResource;
...
class QuestionsOptionsController extends Controller
{
    ...
    public function getQuestionsOption()
    {
        $questions_option = QuestionsOption::get();
        return QuestionsOptionResource::collection($questions_option);
    }
    /**
